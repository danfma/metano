...
/// <c>import { Foo } from "&lt;package&gt;/&lt;subpath&gt;"</c> without ever performing a
...
/// <param name="SubPath">The package-relative subpath of the type's file (no <c>./</c>
/// prefix, no <c>.ts</c> suffix). E.g., <c>"domain/todo"</c>.</param>
...
/// MetaSharp-emitted type uses default export, but the slot is plumbed for forward
