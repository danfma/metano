...
| `[Queryable]` | Method/Parameter | Captures lambda body as expression tree alongside the closure (IQueryable provider input) — runtime descriptor's `expression?` field. |
